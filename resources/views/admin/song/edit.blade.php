                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" placeholder="Title" value="{{ $song->title }}">
                                </div>
                                <p></p>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="composer" id="composer" class="form-control" placeholder="Composer" value="{{ $song->composers }}">
                                </div>
                                <p></p>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="singer" id="singer" class="form-control" placeholder="Singer" value="{{ $song->singers }}">
                                </div>
                                <p></p>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input readonly type="text" name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ $song->slug }}">
                                </div>
                                <p></p>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option {{ ($song->status == 1) ? 'selected' : '' }} value="1">Action</option>
                                        <option {{ ($song->status == 0) ? 'selected' : '' }} value="0">Block</option>
                                    </select>
                                </div>
                            </div>
                        </div>
